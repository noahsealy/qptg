...
class Figure12:
    def __init__(self, rows, cols, win_state, start_state, memory_size,
        ...
        self.illegal_states = [(2, 0), (2, 1), (3, 1), (2, 3), (3, 3), (2, 4)]
    ...
    def check_legal(self, state):
        if (state != (2, 0)) and (state != (2, 1)) and (state != (3, 1)) and (state != (2, 3)) and (state != (3, 3)) and (state != (2, 4)):
            return True
        return False
    ...
    def step(self, action):
        ...
        if (next[0] >= 0 and next[0] <= (self.rows - 1)) and (next[1] >= 0 and next[1] <= (self.cols - 1)):
            illegal = 0
            if (next == (2, 0)) or (next == (2, 1)) or (next == (3, 1)) or (next == (2, 3)) or (next == (3, 3)) or (next == (2, 4)):
                illegal = 1
